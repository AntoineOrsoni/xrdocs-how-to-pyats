...
# Removing changes
base_config = "xrd-1-startup.cfg"
if base_config in xrd1.parse('dir harddisk:')['dir']['files']:
  print(base_config, "in harddisk:")
  xrd1.configure('''
                load harddisk:xrd-1-startup.cfg
                commit replace
                ''')
else: 
  print(base_config, "not in harddisk:")
